...
// Metodi CRUD
import { getChatList } from '../../services/SideService'
  ...
  return (
    <>
      ...
      <div id="side-elements-container">
        ...
        <Routes>
          <Route path='/' element={<SideFeature span={"bookmark"} text={"Messaggi personali"} />} />
        </Routes>

        <Routes>
          <Route path='/chats/*' element={<SideFeature span={"bookmark"} text={"Messaggi personali"} />} />
        </Routes>

        <Routes>
          <Route path='/contacts/*' element={<SideFeature url={"/add"} span={"add"} text={"Aggiungi contatto"} />} />
        </Routes>

        <Routes>
          <Route path='/contacts/*' element={<SideFeature url={"/requests"} span={"mail"} text={"Richieste"} />} />
        </Routes>
